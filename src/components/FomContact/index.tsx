...
export const FormContact = () => { 
  ...
  return (  
    <div className="relative">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col justify-center items-center gap-4 text-colorDark xl:w-1/2 xl:mx-auto">
        <div className="flex flex-col gap-4 w-full">
          <div className="flex flex-col gap-2">
            <div className="flex items-center justify-start gap-2">
              <MdOutlineAccountCircle />
              <label htmlFor="name" className="text-lg lg:text-xl xl:text-2xl">Digite o seu nome</label>
            </div>
            <input 
              placeholder="Nome"
              {...register("name")}
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center justify-start gap-2">
              <MdAlternateEmail />
              <label htmlFor="labelEmail" className="text-lg lg:text-xl xl:text-2xl">Digite o seu e-mail</label>
            </div>
            <input 
              placeholder="E-mail"
              {...register("email")}
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center justify-start gap-2">
              <CiPhone />
              <label htmlFor="labelNumero" className="text-lg lg:text-xl xl:text-2xl">Digite o seu número de celular</label>
            </div>
            <input 
              placeholder="Número"
              {...register("number")}
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center justify-start gap-2">
              <BiMessageSquareEdit />
              <label htmlFor="labelAbout" className="text-lg lg:text-xl xl:text-2xl">Digite o seu assunto</label>
            </div>
            <input 
              placeholder="Assunto"
              {...register("about")}
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center justify-start gap-2">
              <MdOutlineMessage />
              <label htmlFor="labelMessage" className="text-lg lg:text-xl xl:text-2xl">Digite a sua mensagem</label>
            </div>
            <input
