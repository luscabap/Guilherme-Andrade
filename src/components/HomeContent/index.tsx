    ...
    <div id="home-content" className="flex flex-col items-center justify-center gap-4 my-4">
      <div className="flex flex-col items-center justify-center xl:flex-row">
        <div className="flex flex-col items-center justify-center gap-4 xl:w-1/2">
          <h1 className="text-xl text-center md:text-3xl">Olá, sou o <strong>Dr. Guilherme Menezes de Andrade</strong></h1>
          <div>
          ...
          <h3 className="text-lg md:text-3xl">OAB N°: <strong>510.723</strong></h3>
        </div>
