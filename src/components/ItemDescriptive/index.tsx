...
export const ItemDescriptive = ({ description, icon, title, primary }: ItemDescriptiveProps) => {
  ...
  return (
    <div className={` ${darkTheme ? "bg-colorLight" : "bg-colorSecondary "} rounded-lg px-8 pt-4 pb-4 min-h-80 flex flex-col items-center justify-start gap-3 shadow-2xl w-full md:w-3/4 xl:w-1/2`}>
